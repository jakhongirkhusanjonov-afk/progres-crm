...
export default function MySalaryPage() {
  ...
  const fetchSalaryData = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/salary/my-salary?month=${selectedMonth}`, {
        headers: {
  ...
  const getPaidPercentage = () => {
    ...
    return Math.round((salaryData.summary.paidAmount / salaryData.summary.totalSalary) * 100)
  }
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-3 mb-4">
            ...
            <div className="bg-purple-50 rounded-xl p-3 md:p-4 border border-purple-100">
              ...
              <div className="text-xl md:text-2xl font-bold text-purple-700">
                {salaryData.groupDetails.reduce((sum, g) => sum + g.lessonsCount, 0)}
              </div>
            </div>
            ...
            <div className="bg-green-50 rounded-xl p-3 md:p-4 border border-green-100">
              ...
              <div className="text-base md:text-lg font-bold text-green-700 truncate">
                {formatPrice(salaryData.summary.paidAmount).replace(" so'm", '')}
              </div>
            </div>
            ...
            <div className={`rounded-xl p-3 md:p-4 border ${
              ...
              <div className={`flex items-center gap-2 mb-1 ${
                salaryData.summary.debt > 0 ? 'text-red-600' : 'text-green-600'
              }`}>
                <ExclamationCircleOutlined />
                <span className="text-xs font-medium">Qarz</span>
              </div>
              <div className={`text-base md:text-lg font-bold truncate ${
                salaryData.summary.debt > 0 ? 'text-red-700' : 'text-green-700'
              }`}>
            ...
            <div className="text-center">
              ...
              <div className="mt-3">
                {salaryData.summary.debt === 0 ? (
                  ...
                  <Tag color="orange" icon={<ExclamationCircleOutlined />} className="text-sm px-3 py-1">
                    Qisman to'langan
                  </Tag>
                ) : (
                  <Tag color="red" icon={<ExclamationCircleOutlined />} className="text-sm px-3 py-1">
                    Hali to'lanmagan
                  </Tag>
                )}
              </div>
                    ...
                    header={
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 w-full pr-4">
                        <div>
                          ...
                          <span className="text-gray-500 text-xs ml-2">({group.group.course})</span>
                        </div>
                        <div className="flex items-center gap-2">
                  ...
                  >
                    <div className="space-y-3">
                      ...
                      <div className="bg-gray-50 rounded-lg p-3">
                        <h4 className="font-medium text-sm mb-2">Maosh hisob-kitobi</h4>
                        <div className="space-y-1.5 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">{group.teacherPercentage}%</span>
                          </div>
                          <div className="flex justify-between">
